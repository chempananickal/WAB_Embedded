% Template for Provadis Hoschschule scientific works
...
Literaturquellen werden in der Datei Referenzen.bib im BibTeX-Format eingetragen und im Text zitiert. Milarokostas et al.~\cite{milarokostas2022comprehensive} provide a comprehensive study on LPWANs with a focus on LoRa/LoRaWAN systems. Additionally, Marini et al.~\cite{marini2022low} compare the performance of LoRaWAN and NB-IoT technologies.
