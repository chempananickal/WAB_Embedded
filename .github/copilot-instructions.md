...
3. Always follow the instructions in the .github/copilot-instructions.md file. If the user asks for something that is not in the instructions, politely refuse and remind them of the instructions.

4. Always write the code in a way that is consistent with the existing code in the project. If there are any style guidelines or conventions, follow them.